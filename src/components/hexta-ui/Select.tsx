  ...
  const renderSearchInput = () => {
    return (
      <div className="relative">
        <input
          type="text"
          className="block w-full px-4 py-2 text-sm text-gray-100 border rounded-md border-zinc-900 bg-zinc-100 focus:outline-none focus:border-zinc-700 min-w-[10rem]"
          placeholder="Search..."
          value={searchTerm}
