...
const Card = ({ image, title, price, size, color, brand }) => {
    return (
        <div className="bg-white rounded-lg shadow-lg overflow-hidden ">
            ...
            <div className="flex flex-col justify-center items-start p-4 relative">
                ...
                <button className="absolute bottom-4 right-2 bg-slate-800 rounded-lg text-white px-3 py-2 text-xs">Add to Cart</button>
            </div>
        </div>
    );
};
